...
export declare type Join_RedisKeyTemplateArray<arr extends readonly RedisKeyTemplateArrayElements[]> = `${JoinStringArray<RedisKeyTemplateArray_ToStringArray<arr>>}`;
export declare type RedisKeyTemplateArray_ToStringArray<T extends readonly RedisKeyTemplateArrayElements[]> = T extends any ? TailOfArray<T> extends [] ? [makeString_StringOrRedisKeyParam<T[0]>] : readonly [
